    ...
    >
      ...
      <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl w-full max-w-md border border-white/20 relative z-10">
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            <input
              className="border px-4 py-3 rounded-lg w-full focus:outline-none focus:ring-2 transition duration-200 bg-white/90 pl-10 border-gray-300 focus:ring-blue-400"
